    ...
    public static void main(String[] args) {
        ...
        while (true) {
            try {
                ...
                e.printStackTrace();
                System.out.println("Ứng dụng đã gặp mỗi số lỗi, xin vui lòng thử lại");
            }
        }
    }
    ...
    private static void menuSort() {
        ...
        while (true) {
            do {
                ...
                System.out.println("1. Sắp xếp theo thứ tự tự nhiên");
                System.out.println("2. Sắp xếp theo thứ tự ngược lại");
